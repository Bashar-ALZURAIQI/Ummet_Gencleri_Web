...
INSERT INTO public.cms_localizations (
  ...
  'tr',
  'published',
  '[{"id":"presidency","name":"Birlik Başkanlığı","shortName":"Birlik Başkanı","description":"Birliğin en üst liderlik organı olup Birlik Başkanı liderliğinde genel politikaları belirler, Birliği temsil eder ve tüm komitelerin çalışmalarını koordine eder.","responsibilities":["Stratejik vizyon ve genel politikaları belirleme","Birliği kurumlar nezdinde temsil etme","Tüm komitelerin performansını genel gözetim","Yıllık plan ve bütçeleri onaylama","Yönetim Kurulu toplantılarına başkanlık etme"]},{"id":"vice-presidency","name":"Başkan Yardımcılığı","shortName":"Başkan Yardımcısı","description":"Kararların uygulanmasını takip eder, komiteler arası koordinasyonu sağlar ve Başkanın yokluğunda vekalet eder.","responsibilities":["Yönetim Kurulu kararlarının uygulanmasını takip","Komiteler arası iş birliğini koordine etme","Operasyonel planları denetleme","Başkanın yokluğunda görev ve yetkileri üstlenme","Periyodik performans raporları hazırlama"]},{"id":"media","name":"Medya Komitesi","shortName":"Medya","description":"Birliğin kurumsal kimliğini ve dijital platformlar, basın ve görsel materyaller üzerinden kamuoyu iletişimini yönetir.","responsibilities":["Sosyal medya hesaplarını profesyonelce yönetme","Etkinlik ve faaliyetlerin medya kapsamını sağlama","Dijital ve basılı içerik üretimi","Basın kuruluşları ile koordinasyon","Periyodik bülten ve yayınlar çıkarma"]},{"id":"academic","name":"Akademik Komite","shortName":"Akademik","description":"Kurslar, seminerler, paneller ve bilimsel rehberlik yoluyla öğrencilerin akademik gelişimini destekler.","responsibilities":["Eğitim kursları ve atölyeler düzenleme","Akademik konferans ve seminerler tertipleme","Öğrencilere akademik danışmanlık sağlama","Birlik bilimsel kütüphanesini yönetme","Ortak üniversitelerle programları koordine etme"]},{"id":"supervisory","name":"Denetim ve Teftiş Komitesi","shortName":"Denetim","description":"Birlik içi mevzuata uyumu, şeffaflığı ve kurumsal işleyişin dürüstlüğünü denetleyen bağımsız organdır.","responsibilities":["İç tüzük ve düzenlemelere uyumu denetleme","İdari ve mali raporları inceleme","Gelen bildirim ve şikayetleri değerlendirme","Komite ve üyelerin performansını değerlendirme","Periyodik şeffaflık raporları hazırlama"]},{"id":"activities","name":"Faaliyetler Komitesi","shortName":"Faaliyetler","description":"Geziler, seminerler, gönüllülük kampanyaları ve spor etkinlikleri ile öğrenci katılımını canlı tutar.","responsibilities":["Sosyal ve kültürel faaliyetleri planlama ve yönetme","Gönüllülük kampanyalarını koordine etme","Kültür ve doğa gezileri düzenleme","Öğrenci kulüpleri ile iş birliği","Öğrenci katılımını aktif kılma"]},{"id":"finance","name":"Maliye Komitesi","shortName":"Maliye","description":"Birliğin mali kaynaklarını yönetir, bütçe tahminlerini hazırlar ve harcamaları şeffaflıkla denetler.","responsibilities":["Yıllık bütçeyi hazırlama","Gelir ve giderleri düzenli takip etme","Bağış ve sponsorluk süreçlerini yönetme","Dönemsel mali raporları hazırlama","Denetim komitesi ile koordinasyon"]}]'::jsonb,
  'fresh',
  ARRAY['*']::text[],
  ARRAY[]::text[],
  'c1afb514',
